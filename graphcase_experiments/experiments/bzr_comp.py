...
PATH = 'graphcase_experiments/data/bzr/'  #for the results
...
def calc_bzr_performance(algos=ALGO, G=None, source_path=SOURCE_PATH, test_size = 0.5, runs=1):
    ...
    with mlflow.start_run():
        ...
        smry_df.to_csv(PATH + 'smry_res', index=True)
